 ...
 * Author: philip
 *
 * Created on 04 February 2018, 20:19
 */
...
unsigned char write_character(unsigned char *ptr, unsigned char inc, unsigned char page)
{
    unsigned char x = 0;
        ...
        // set_columns(set column address,col start address (0->d'127), col end address (0->d'127))
        ...
        return x - 16;              // determines spacing between characters
}